...
const AboutPage = () => {
  ...
  return (
    <>
      <Head>
        <title>About ZakGifts – Trusted Digital Gift Card Marketplace</title>
        <meta 
          name="description" 
          content="Built by gamers, for gamers. ZakGifts delivers legit codes fast and securely. Discover why over 10,000+ customers trust us worldwide." 
        />
        <meta property="og:title" content="About ZakGifts – Trusted Digital Gift Card Marketplace" />
        <meta 
          property="og:description" 
          content="Built by gamers, for gamers. ZakGifts delivers legit codes fast and securely. Discover why over 10,000+ customers trust us worldwide." 
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://zakgifts.com/about" />
              ...
              <div className="relative z-10">
                <div className="text-center">
                  ...
                  <p className="text-purple-100 max-w-2xl mx-auto mb-8 text-lg">
                    Join thousands of gamers who trust ZakGifts for instant, reliable gift cards.
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Founded by passionate gamers who were tired of unreliable gift card services, ZakGifts was born out of frustration and built with love.
              </p>
            </div>
